...
(function(a){a.jqplot.PointLabels=function(b){this.show=a.jqplot.config.enablePlugins;this.location="n";this.labelsFromSeries=false;this.seriesLabelIndex=null;this.labels=[];this._labels=[];this.stackedValue=false;this.ypadding=6;this.xpadding=6;this.escapeHTML=true;this.edgeTolerance=-5;this.formatter=a.jqplot.DefaultTickFormatter;this.formatString="";this.hideZeros=false;this._elems=[];a.extend(true,this,b)};var b=["nw","n","ne","e","se","s","sw","w"];var c={nw:0,n:1,ne:2,e:3,se:4,s:5,sw:6,w:7};var d=["se","s","sw","w","nw","n","ne","e"];a.jqplot.PointLabels.init=function(b,c,d,e,f){var g=a.extend(true,{},d,e);g.pointLabels=g.pointLabels||{};if(this.renderer.constructor===a.jqplot.BarRenderer&&this.barDirection==="horizontal"&&!g.pointLabels.location){g.pointLabels.location="e"}this.plugins.pointLabels=new a.jqplot.PointLabels(g.pointLabels);this.plugins.pointLabels.setLabels.call(this)};a.jqplot.PointLabels.prototype.setLabels=function(){var b=this.plugins.pointLabels;if(typeof b.onlySeriesIndex==="number"&&this.index!==b.onlySeriesIndex)return;var c;if(b.seriesLabelIndex!=null){c=b.seriesLabelIndex}else if(this.renderer.constructor===a.jqplot.BarRenderer&&this.barDirection==="horizontal"){c=0}else{c=this._plotData.length===0?0:this._plotData[0].length-1}b._labels=[];if(b.labels.length===0||b.labelsFromSeries){if(b.stackedValue){if(this._plotData.length&&this._plotData[0].length){for(var d=0;d<this._plotData.length;d++){b._labels.push(this._plotData[d][c])}}}else{var e=this.data;if(this.renderer.constructor===a.jqplot.BarRenderer&&this.waterfall){e=this._data}if(e.length&&e[0].length){for(var d=0;d<e.length;d++){b._labels.push(e[d][c])}}e=null}}else if(b.labels.length){b._labels=b.labels}};a.jqplot.PointLabels.prototype.xOffset=function(a,b,c){b=b||this.location;c=c||this.xpadding;var d;switch(b){case"nw":d=-a.outerWidth(true)-this.xpadding;break;case"n":d=-a.outerWidth(true)/2;break;case"ne":d=this.xpadding;break;case"e":d=this.xpadding;break;case"se":d=this.xpadding;break;case"s":d=-a.outerWidth(true)/2;break;case"sw":d=-a.outerWidth(true)-this.xpadding;break;case"w":d=-a.outerWidth(true)-this.xpadding;break;case"c":console.log("lol");d=0;break;default:d=-a.outerWidth(true)-this.xpadding;break}return d};a.jqplot.PointLabels.prototype.yOffset=function(a,b,c){b=b||this.location;c=c||this.xpadding;var d;switch(b){case"nw":d=-a.outerHeight(true)-this.ypadding;break;case"n":d=-a.outerHeight(true)-this.ypadding;break;case"ne":d=-a.outerHeight(true)-this.ypadding;break;case"e":d=-a.outerHeight(true)/2;break;case"se":d=this.ypadding;break;case"s":d=this.ypadding;break;case"sw":d=this.ypadding;break;case"w":d=-a.outerHeight(true)/2;break;case"c":console.log("lol");d=-a.outerHeight(true)/2;break;default:d=-a.outerHeight(true)-this.ypadding;break}return d};a.jqplot.PointLabels.draw=function(b,e,f){var g=this.plugins.pointLabels;g.setLabels.call(this);for(var h=0;h<g._elems.length;h++){g._elems[h].emptyForce()}g._elems.splice(0,g._elems.length);if(g.show){var i="_"+this._stackAxis+"axis";if(!g.formatString){g.formatString=this[i]._ticks[0].formatString;g.formatter=this[i]._ticks[0].formatter}var j=this._plotData;var k=this._prevPlotData;var l=this._xaxis;var m=this._yaxis;var n,o;for(var h=0,p=g._labels.length;h<p;h++){var q=g._labels[h];if(g.hideZeros&&parseInt(g._labels[h],10)==0){q=""}if(q!=null){q=g.formatter(g.formatString,q)}o=document.createElement("div");g._elems[h]=a(o);n=g._elems[h];n.addClass("jqplot-point-label jqplot-series-"+this.index+" jqplot-point-"+h);n.css("position","absolute");n.insertAfter(b.canvas);if(g.escapeHTML){n.text(q)}else{n.html(q)}var r=g.location;if(this.fillToZero&&j[h][1]<0||this.fillToZero&&this._type==="bar"&&this.barDirection==="horizontal"&&j[h][0]<0||(this.waterfall&&parseInt(q,10))<0){r=d[c[r]]}var s=l.u2p(j[h][0])+g.xOffset(n,r);var t=m.u2p(j[h][1])+g.yOffset(n,r);if(this._stack&&!g.stackedValue){if(this.barDirection==="vertical"){t=(this._barPoints[h][0][1]+this._barPoints[h][1][1])/2+f._gridPadding.top-.5*n.outerHeight(true)}else{s=(this._barPoints[h][2][0]+this._barPoints[h][0][0])/2+f._gridPadding.left-.5*n.outerWidth(true)}}if(this.renderer.constructor==a.jqplot.BarRenderer){if(this.barDirection=="vertical"){s+=this._barNudge}else{t-=this._barNudge}}n.css("left",s);n.css("top",t);var u=s+n.width();var v=t+n.height();var w=g.edgeTolerance;var x=a(b.canvas).position().left;var y=a(b.canvas).position().top;var z=b.canvas.width+x;var A=b.canvas.height+y;if(s-w<x||t-w<y||u+w>z||v+w>A){n.remove()}n=null;o=null}}};a.jqplot.postSeriesInitHooks.push(a.jqplot.PointLabels.init);a.jqplot.postDrawSeriesHooks.push(a.jqplot.PointLabels.draw)})(jQuery);
